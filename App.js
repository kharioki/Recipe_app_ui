  ...
  const recipes = [
    {
      ...
      image: require('./assets/pad-thai.jpeg'),
    },
    {
      name: 'Thai Noodle Salad',
      info: '60 min | 3 servings',
      image: require('./assets/Thai-Noodle-Salad.jpg'),
    },
    {
      name: 'Rice Noodles',
    ...
    {
      name: 'Nam-Jim (Thai peanut sauce)',
      info: '45 min | 2 servings',
      image: require('./assets/thai-peanut-sauce-namjim.png'),
    },
  ];
  return (
    <Container>
      <StatusBar barStyle="light-content" />
      <RecipeBackground source={require('./assets/szechuan.jpg')}>
        <SafeAreaView>
          <MenuBar>
            <Back>
